          ...
          {data.map(({ id, image, title, time, location, desc, company }) => {
            return (
              ...
              >
                ...
                <button className="bg-blueColor text-white group-hover/item:border-white border-blueColor border-[2px] rounded-[10px] block p-[10px] w-full text-[14px] font-semibold  group-hover/item:text-textColor group-hover:text-white transition-all delay-75">
                  Apply Now
                </button>
              </div>
            );
