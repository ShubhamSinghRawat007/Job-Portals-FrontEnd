...
export const FeaturedJobs = () => {
  return (
    <div className='' >
      <Title text1={'Featured '} text2={'Jobs'} />
          ...
          {data.map(({ id, image, title, time, location, desc, company }) => {
            return (
              ...
              >
                ...
                <button className="bg-blueColor text-white border-[2px] border-blueColor  rounded-[10px] block p-[10px] w-full text-[14px] font-semibold group-hover/item:border-white  group-hover/item:text-textColor group-hover:text-white transition-all delay-75">
                  Apply Now
                </button>
              </div>
            );
